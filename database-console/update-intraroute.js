...
async function updateDataForOneMode(mode, mongoClient) {
    try {
        ...
        let dbStopsCollection = mongoClient.db(dbname).collection(dbStopsCollectionName);
        let dbRoutesCollection = mongoClient.db(dbname).collection(dbRoutesCollectionName);
...
async function updateIntraRoute(mongoClient, res) {
    try {
        updateDataForOneMode('bahn', mongoClient);
        updateDataForOneMode('air', mongoClient);
        updateDataForOneMode('rail', mongoClient);
        updateDataForOneMode('sail', mongoClient);
        updateDataForOneMode('bus', mongoClient);
        updateDataForOneMode('omega', mongoClient);
        updateDataForOneMode('railScar', mongoClient);
        updateDataForOneMode('railLumeva', mongoClient);
...
module.export = { updateIntraRoute };